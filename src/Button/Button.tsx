...
const button = cva(styles[`lambda-btn`], {
    ...
    compoundVariants: [
        { color: "primary", variant: 'classic', className: styles[`lambda-btn--primary-classic`] },
        ...
        { color: "primary", variant: 'text', className: styles[`lambda-btn--primary-text`] },
        { color: "secondary", variant: 'classic', className: styles[`lambda-btn--secondary-solid`] },
        ...
        { color: "secondary", variant: 'text', className: styles[`lambda-btn--secondary-text`] },
        { color: "danger", variant: 'classic', className: styles[`lambda-btn--danger-classic`] },
        ...
        { color: "danger", variant: 'text', className: styles[`lambda-btn--danger-text`] },
        { color: "success", variant: 'classic', className: styles[`lambda-btn--success-classic`] },
        ...
        { color: "success", variant: 'text', className: styles[`lambda-btn--success-text`] },
        { color: "warning", variant: 'classic', className: styles[`lambda-btn--warning-classic`] },
        ...
        { color: "warning", variant: 'text', className: styles[`lambda-btn--warning-text`] },
        { color: "info", variant: 'classic', className: styles[`lambda-btn--info-classic`] },
        ...
        { color: "info", variant: 'text', className: styles[`lambda-btn--info-text`] },
    ],
    defaultVariants: {
        color: "primary",
        variant: "solid",
