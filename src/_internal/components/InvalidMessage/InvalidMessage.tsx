...
export function InvalidMessage({
	...
	return (
		<div
			className={invalidMessage({ invalid, size })}
			style={
				{ "--after-left": marginArrow ? `${marginArrow + 6}px` : "6px" } as React.CSSProperties
			}
		>
			<TriangleAlert className={styles["lambda-message-invalid-icon"]} />
