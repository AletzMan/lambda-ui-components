...
export interface DialogProps extends Omit<React.InputHTMLAttributes<HTMLInputElement>, "children" | "title"> {
    /**
    ...
    /**
     * Si es `true`, hacer clic en el área oscura (overlay) fuera del panel del diálogo
    ...
    // Si usas CVA para variantes de color o estilo general que no estén ligadas a la animación:
    // overlayVariant?: VariantProps<typeof dialogOverlayVariants>['variant'];
    // panelVariant?: VariantProps<typeof dialogPanelVariants>['variant'];

    // Opcional: Permite especificar un elemento contenedor diferente para el portal en lugar de document.body
