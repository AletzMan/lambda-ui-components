...
export interface TextAreaProps extends Omit<TextareaHTMLAttributes<HTMLTextAreaElement>, "disabled" | "aria-invalid" | "aria-describedby" | "aria-labelledby" | "onFocus" | "onBlur"> {
     ...
     */
    variant?: TextAreaVariants["variant"]; // Asumiendo que TextAreaVariants es un tipo generado por CVA

    /**
     * Define el radio de las esquinas del área de texto.
     */
    radius?: TextAreaVariants["radius"]; // Asumiendo que TextAreaVariants es un tipo generado por CVA

    /**
     * Define el tamaño del área de texto, afectando el padding y el tamaño de fuente.
     */
    size?: TextAreaVariants["size"]; // Asumiendo que TextAreaVariants es un tipo generado por CVA
