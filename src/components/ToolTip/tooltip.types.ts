...
export interface TooltipProps extends Omit< // Omitir props de HTMLAttributes<HTMLDivElement> que vamos a redefinir
...
> {
    ...
    /**
     * Tamaño del tooltip (afecta padding, font-size).
     * @default 'medium'
     */
    size?: TooltipContainerVariants['size'];
