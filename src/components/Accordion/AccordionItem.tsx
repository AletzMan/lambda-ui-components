...
import { AccordionContentFinalInjectedProps, AccordionContentProps, AccordionHeaderFinalInjectedProps, AccordionHeaderProps, AccordionItemProps } from "./accordion.types";
...
export const AccordionItem = forwardRef<HTMLDivElement, AccordionItemProps>(
    (
        ...
        const renderedChildren = Children.map(children, (child) => {
            ...
            console.warn('AccordionItem should only contain AccordionHeader and AccordionContent elements.', child);
            return child;
        });
