import { HTMLAttributes, forwardRef, useCallback, useLayoutEffect, useRef, useState } from "react";
...
export const AccordionContent = forwardRef<HTMLDivElement, AccordionContentProps>(
    (
        ...
        useLayoutEffect(() => {
            ...
            if (!innerElement) {
                console.log(`AccordionContent [${associatedItemValue}]: Inner element ref not found.`);
                return;
            }
            ...
            return () => {
                console.log(`AccordionContent [${associatedItemValue}]: useLayoutEffect cleanup.`);
            };
        ...
        // --- Clases CSS --- 
        const contentClasses = clsx(accordionContentVariants({ state: isItemOpen ? 'open' : 'closed', size }), className);
