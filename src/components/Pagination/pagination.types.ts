...
export interface PaginationProps extends HTMLAttributes<HTMLElement> {
    ...
    /**
     * Radio de los bordes de los botones de paginación.
     * @default "small"
     */
    radius?: PaginationButtonRadius; // Usar el tipo de variante de radio
...
export interface PaginationButtonProps extends ButtonHTMLAttributes<HTMLButtonElement>, PaginationButtonVariants {
    /**
