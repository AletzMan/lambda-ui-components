...
const PreviewCarousel = (args: Partial<CarouselProps & React.RefAttributes<HTMLDivElement>> | undefined) => {


    return (
        <div style={{ display: 'flex', padding: '1em', maxWidth: '60em', width: 'auto' }}>
            <Carousel
                {...args}
