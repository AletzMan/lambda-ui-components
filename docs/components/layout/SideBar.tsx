...
export function SideBar() {
	return (
		<aside className="sticky top-18 h-[calc(100svh-72px)] bg-[linear-gradient(to_right,var(--surface-a),var(--background-color),var(--background-color),transparent)] border-r border-gray-200/3 scrollBar overflow-x-auto">
